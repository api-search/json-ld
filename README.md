# json-ld.apis.io — JSON-LD Contexts

[**json-ld.apis.io**](https://json-ld.apis.io) indexes JSON-LD context documents that describe the entities behind the APIs in the network. Where JSON Schemas describe structure, JSON-LD describes meaning — what classes and properties an API\'s entities map to in shared vocabularies (Schema.org, FOAF, custom org vocabs).

**Live site:** [https://json-ld.apis.io](https://json-ld.apis.io)

## What's in this repo

- **`_jsonld/`** — one Markdown file per JSON-LD context, organized by provider. Front matter carries class and property counts and cross-links to schemas and APIs that use the context.
