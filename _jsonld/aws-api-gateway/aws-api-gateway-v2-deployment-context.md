...
classes:
- Deployment
context_file: json-ld/aws-api-gateway-v2-deployment-context.jsonld
context_url: https://raw.githubusercontent.com/api-evangelist/aws-api-gateway/refs/heads/main/json-ld/aws-api-gateway-v2-deployment-context.jsonld
description: JSON-LD context defining the semantic vocabulary for Aws Api Gateway V2 Deployment from Amazon API Gateway.
layout: jsonld
