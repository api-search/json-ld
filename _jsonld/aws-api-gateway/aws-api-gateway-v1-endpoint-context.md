...
context_file: json-ld/aws-api-gateway-v1-endpoint-context.jsonld
context_url: https://raw.githubusercontent.com/api-evangelist/aws-api-gateway/refs/heads/main/json-ld/aws-api-gateway-v1-endpoint-context.jsonld
description: JSON-LD context defining the semantic vocabulary for Aws Api Gateway V1 Endpoint from Amazon API Gateway.
layout: jsonld
