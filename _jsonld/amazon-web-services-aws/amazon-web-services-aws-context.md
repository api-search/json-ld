...
- filename: openapi.yaml
  format: yaml
  label: Amazon Kinesis API
  slug: amazon-kinesis-api
  spec_type: OpenAPI
...
- filename: openapi.yaml
  format: yaml
  label: Elastic Load Balancing API
  slug: elastic-load-balancing-api
  spec_type: OpenAPI
  url: https://api.apis.guru/v2/specs/amazonaws.com/elasticloadbalancingv2/2015-12-01/openapi.yaml
- filename: openapi.yaml
  format: yaml
  label: AWS Secrets Manager API
  slug: aws-secrets-manager-api
  spec_type: OpenAPI
...
- filename: openapi.yaml
  format: yaml
  label: AWS AppSync API
  slug: aws-appsync-api
  spec_type: OpenAPI
  url: https://api.apis.guru/v2/specs/amazonaws.com/appsync/2017-07-25/openapi.yaml
- filename: openapi.yaml
  format: yaml
  label: AWS App Runner API
  slug: aws-app-runner-api
  spec_type: OpenAPI
...
- filename: openapi.yaml
  format: yaml
  label: AWS Certificate Manager API
  slug: aws-certificate-manager-api
  spec_type: OpenAPI
  url: https://api.apis.guru/v2/specs/amazonaws.com/acm/2015-12-08/openapi.yaml
- filename: openapi.yaml
  format: yaml
  label: AWS CloudTrail API
  slug: aws-cloudtrail-api
  spec_type: OpenAPI
...
- filename: openapi.yaml
  format: yaml
  label: Amazon Connect API
  slug: amazon-connect-api
  spec_type: OpenAPI
  url: https://api.apis.guru/v2/specs/amazonaws.com/connect/2017-08-08/openapi.yaml
- filename: openapi.yaml
  format: yaml
  label: AWS Database Migration Service API
  slug: aws-database-migration-service-api
  spec_type: OpenAPI
  url: https://api.apis.guru/v2/specs/amazonaws.com/dms/2016-01-01/openapi.yaml
- filename: openapi.yaml
  format: yaml
  label: AWS Direct Connect API
  slug: aws-direct-connect-api
  spec_type: OpenAPI
...
- filename: openapi.yaml
  format: yaml
  label: AWS Global Accelerator API
  slug: aws-global-accelerator-api
  spec_type: OpenAPI
...
- filename: openapi.yaml
  format: yaml
  label: Amazon Rekognition API
  slug: amazon-rekognition-api
  spec_type: OpenAPI
...
- filename: openapi.yaml
  format: yaml
  label: Amazon Transcribe API
  slug: amazon-transcribe-api
  spec_type: OpenAPI
  url: https://api.apis.guru/v2/specs/amazonaws.com/transcribe/2017-10-26/openapi.yaml
- filename: openapi.yaml
  format: yaml
  label: Amazon Translate API
  slug: amazon-translate-api
  spec_type: OpenAPI
...
class_count: 0
classes: []
context_file: json-ld/amazon-web-services-aws-context.jsonld
context_url: https://raw.githubusercontent.com/api-evangelist/amazon-web-services-aws/refs/heads/main/json-ld/amazon-web-services-aws-context.jsonld
description: JSON-LD context defining the semantic vocabulary for Amazon Web Services Aws from Amazon Web Services (AWS).
layout: jsonld
name: Amazon Web Services Aws Context
namespaces:
- prefix: amazon_web_services_aws
  uri: https://aws.amazon.com/amazon-web-services-aws/vocab#
properties: []
property_count: 0
