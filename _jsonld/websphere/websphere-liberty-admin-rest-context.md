...
source_filename: websphere-liberty-admin-rest-context.jsonld
source_heading: JSON-LD Document
source_json: "{\n  \"@context\": {\n    \"@version\": 1.1,\n    \"xsd\": \"http://www.w3.org/2001/XMLSchema#\"\n  }\n}"
source_json_url: https://raw.githubusercontent.com/api-evangelist/websphere/refs/heads/main/json-ld/websphere-liberty-admin-rest-context.jsonld
tags:
- Application Server
- Cloud Native
- Enterprise Java
