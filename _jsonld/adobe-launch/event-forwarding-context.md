...
class_count: 0
classes: []
context_file: json-ld/event-forwarding-context.jsonld
context_url: https://raw.githubusercontent.com/api-evangelist/adobe-launch/refs/heads/main/json-ld/event-forwarding-context.jsonld
description: JSON-LD context defining the semantic vocabulary for Event Forwarding from Adobe Launch.
layout: jsonld
...
source_filename: event-forwarding-context.jsonld
source_heading: JSON-LD Document
source_json: "{\n  \"@context\": {\n    \"@version\": 1.1,\n    \"xsd\": \"http://www.w3.org/2001/XMLSchema#\"\n  }\n}"
source_json_url: https://raw.githubusercontent.com/api-evangelist/adobe-launch/refs/heads/main/json-ld/event-forwarding-context.jsonld
tags:
- Data Collection
- Edge Network
- Event Forwarding
